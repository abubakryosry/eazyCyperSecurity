...
export default function ContactUs({ locale }: ContactProps) {
  ...
  return (
    ...
    >
      ...
      {/* Content */}
      <div
        className="relative max-w-6xl mx-auto flex flex-col my-8"
        data-aos="fade-up"
      >
        ...
        >
          <div className="flex flex-col mb-6 md:mb-0">
            <p className="font-normal mb-3 text-md md:text-xl block">
              {locale === "ar"
          ...
          <div className="text-2xl" data-aos="zoom-in">
            <Link
              href={locale === "ar" ? "/ar/contactUs" : "/en/contactUs"}
              className="flex items-center justify-center gap-2 py-2.5 px-4 rounded-xl text-2xl font-normal bg-white text-[#0C2551] hover:text-blue-800 transition-colors duration-200"
            >
