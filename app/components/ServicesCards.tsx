  ...
  return (
    ...
    >
      {servicesData.map((service, index) => (
        <div
          key={index}
          className={`flex flex-col md:flex-row items-center justify-between gap-8 bg-white rounded-xl p-6 md:p-10 shadow ${
        ...
        >
          ...
          <div className="md:w-1/2 flex flex-col items-start gap-3 text-center md:text-start">
            ...
            <Link
              href={service.link}
              className="mt-3 bg-blue-600 hover:bg-blue-700 text-white px-6 py-2 rounded-lg transition-all inline-block text-center"
            >
